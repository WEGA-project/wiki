...
[СПИСОК ДАТЧИКОВ](Список_поддерживаемых_датчиков.md)![Контроллер в сборе](assets/WEGABOX-KIT_board.png)
...
- На модуле mini560 есть площадка, замкнув которую, можно подключить в работу индикатор подачи питания.![без](assets/Led_mini560.png)
