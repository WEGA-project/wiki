...
Для установки платформы [VSCODE](https://code.visualstudio.com/) и настройки работы воспользуйтесь шагами 1-3 из инструкции по [прошивке контроллера для WEGABOX](Прошивка.md)![300x300пкс](assets/Mixer_cs_code.png)
