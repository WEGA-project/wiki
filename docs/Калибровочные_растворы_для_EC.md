...
# Изготовление разовой порции для калибровки ЕС от 0 мСм/см до нескольких единиц путем добавления в заранее отмеренному объему воды ампулы с раствором препарата.
  ...
  2. Вливаем первую ампулу, перемешиваем не вынимая электрод.
  3. Выжидаем время, 10-30 минут пока значения на графиках не стабилизируются.
  4. Добавляем еще ампулу и снова ждем стабилизации и т.д.
